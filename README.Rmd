...
[![Build Status](https://travis-ci.org/kjhealy/socviz.svg?branch=master)](https://travis-ci.org/kjhealy/socviz) [![](https://img.shields.io/github/downloads/:user/:repo/total.svg)](https://github.com/kjhealy/socviz)
